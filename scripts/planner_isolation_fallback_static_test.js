...
assert.match(agentPlanner, /CHAT_HISTORY: \[projectMemory, transcript, userGuidance\]/);
assert.match(agentPlanner, /PLAN_SUMMARY: \[projectMemory, planSummary, userGuidance, phaseScope\]/);
