...
## Memory
Durable project knowledge is in `~/.Codex/projects/-Users-macbookair2020-Downloads-Projects-and-Code-AI-EXE/memory/` (index: `MEMORY.md`). Check it before acting; update it after non-obvious changes.
